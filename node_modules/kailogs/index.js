...
exports.debug = function (message, where) {
    ...
    var logMessage = `[${GetTime()}] [${where}/DEBUG] [${script}]: ${message}`;
...
exports.error = function (message, where) {
    ...
    var logMessage = `[${GetTime()}] [${where}/ERROR] [${script}]: ${message}`;
    console.log(logMessage);
...
exports.log = function (message, where) {
    ...
    var logMessage = `[${GetTime()}] [${where}/INFO] [${script}]: ${message}`;
    console.log(logMessage);
...
exports.warn = function (message, where) {
    ...
    var logMessage = `[${GetTime()}] [${where}/WARN] [${script}]: ${message}`;
    console.log(logMessage);
...
exports.write = function (message, where, type) {
    ...
    var logMessage = `[${GetTime()}] [${where}/${type}] [${script}]: ${message}`;
    console.log(logMessage);
}
